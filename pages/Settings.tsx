    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/40 border border-slate-100 p-6">
        <div className="flex items-center space-x-4 mb-6">
          <div className="w-16 h-16 rounded-full bg-cyan-600 text-white flex items-center justify-center font-bold text-sm">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
            ...
            <button className="px-3 py-3 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors text-sm font-bold text-slate-700">
              Edit
            </button>
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
            <div className="flex items-center space-x-3">
              <Database className="text-cyan-600" size={16} />
              <div>
                <p className="text-sm font-bold text-slate-800">Data Management</p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-red-100 p-6">
        ...
        <div className="flex items-center justify-between p-4 bg-red-50 rounded-xl">
          <div>
            <p className="text-sm font-bold text-red-800">Logout</p>
            <p className="text-xs text-red-600">Sign out of your account</p>
          </div>
          <button
            onClick={handleLogout}
            className="flex items-center space-x-2 px-3 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm font-bold"
          >
            <LogOut size={16} />
            <span>Logout</span>
          </button>
